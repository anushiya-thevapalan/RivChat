...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(toolbar != null) {
            ...
            getSupportActionBar().setTitle("FACYMO");
        }
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.about) {
            Toast.makeText(this, "FACYMO version 1.0", Toast.LENGTH_LONG).show();
            return true;
        }

        if (id == R.id.chatbot) {
            Intent myIntent = new Intent(MainActivity.this, Asssitant.class);
